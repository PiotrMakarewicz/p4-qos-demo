...
control MyIngress(inout headers hdr,
    ...
    action default_forwarding() {
        // TODO
        // Lookup DSCP value for Default Forwarding and set it in the proper IP header field
    }

    /* Voice Admit */
    action voice_admit() {
        // TODO
        // Lookup DSCP value for Voice Admit and set it in the proper IP header field
    }

    /* Expedited Forwarding */
    action expedited_forwarding() {
        // TODO
        // Lookup DSCP value for Expedited Forwarding and set it in the proper IP header field
    }
    ...
    apply {
        if (hdr.ipv4.isValid()) {
            // TODO
            // If packet's protocol is:
            // - TCP - use Voice Admit
            // - UDP - use Expedited Forwarding
            // Otherwise, use Default Forwarding
            ipv4_lpm.apply();
        }
    }
}
